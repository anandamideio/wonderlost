...
export class Toasted extends Tome {
  ...
  constructor(DEBUG = false) {
    ...
    this.registerSettings([
      {
        name: this.localize('toastDuration_name'),
        hint: this.localize('toastDuration_hint'),
        type: Number,
      ...
      {
        name: this.localize('maxMessages_name'),
        hint: this.localize('maxMessages_hint'),
        type: Number,
      ...
      {
        name: this.localize('alwaysShow_name'),
        hint: this.localize('alwaysShow_hint'),
        type: Boolean,
      ...
      {
        name: this.localize('toastPosition_name'),
        hint: this.localize('toastPosition_hint'),
        type: String,
        defaultValue: this.toastPosition,
        choices: {
          upperLeft: this.localize('toastPosition_topLeft'),
          upperCenter: this.localize('toastPosition_topCenter'),
          upperRight: this.localize('toastPosition_topRight'),
          middleLeft: this.localize('toastPosition_middleLeft'),
          middleCenter: this.localize('toastPosition_middleCenter'),
          middleRight: this.localize('toastPosition_middleRight'),
          lowerLeft: this.localize('toastPosition_bottomLeft'),
          lowerCenter: this.localize('toastPosition_bottomCenter'),
          lowerRight: this.localize('toastPosition_bottomRight'),
        },
        scope: 'world',
        restricted: false,
        onChange: (value) => {
